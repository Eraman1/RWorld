...
export default function CreateBlog({
  ...
  useEffect(() => {
    ...
    if (blogData?.content) {
      quillRef.current.clipboard.dangerouslyPasteHTML(blogData.content);
    }
  ...
  const removeTocItem = (tocToRemove: string): void => {
    setFormData((prev) => ({
      ...prev,
      tableOfContents: prev.tableOfContents.filter(
        (toc) => toc !== tocToRemove
      ),
    }));
  };
    ...
    <div className="max-w-4xl my-12 mx-auto p-6  min-h-screen">
        ...
        <div className="flex justify-between items-center mb-8">
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-3xl font-bold text-gray-800 dark:text-gray-100">
              {isEdit ? "Edit rworld Blog Post" : "Create rworld New Blog Post"}
            </h1>
          </div>
      ...
      <div className="border border-gray-300 dark:border-gray-700 rounded-lg p-5 mb-6">
        ...
        <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
          ...
          <span className="font-semibold"> “rworldBlog” </span> naam ka folder
        ...
        <p className="text-gray-700 dark:text-gray-300 mt-3 leading-relaxed">
          ...
          <span className="font-mono bg-gray-100 dark:bg-gray-800 px-2 py-1 rounded text-sm">
            https://stockit.rworldsoftware.in/image/rworldBlog/imageNameWithExtension
          </span>
        </p>
