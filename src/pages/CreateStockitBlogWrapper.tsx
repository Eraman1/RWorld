...
import type { BlogPostFormData } from "@/api/stockitBlog";
import CreateStockitBlog from "./CreateStockitBlog";
...
export default function CreateStockitBlogWrapper() {
    ...
    useEffect(() => {
        ...
        const fetchBlog = async () => {
            try {
                const res = await API.get(`/stockit-blogs/${id}`);
                setBlogData({
                    ...res.data,
    ...
    return <CreateStockitBlog blogData={blogData} isEdit={true} blogId={id} />;
}
